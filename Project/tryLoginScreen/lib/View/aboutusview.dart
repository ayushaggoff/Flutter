  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/aboutAward7.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/Software_Developers_India_2019.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/aboutAward4.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/aboutAward1.png',
            fit: BoxFit.cover,
            height: 50,
          ),
          Padding(
            padding: const EdgeInsets.only(top: 8.0),
            child: Text("Technology Fast",
                style: TextStyle(
                    color: Colors.grey,
                    fontSize: 17.0,
                    fontWeight: FontWeight.w600)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/aboutAward2.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/award1.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/award3.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image.network(
            'https://successive.tech/wp-content/themes/successive/images/award2.png',
            fit: BoxFit.cover,
            height: 100,
          ),
          Padding(
