                        ...
                        child: MaterialButton( 
                         ...
                         autofocus: true,
                          onPressed: () async {
                            ...
                            userRegBloc.add(SignUpButtonPressedEvent(email: emailController.text,password: passwordController.text,dob:dateCtl.text,gender:gender,phone: phoneController.text,username: nameController.text  ));
//                   try{
