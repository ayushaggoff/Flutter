...
_sharedetail(){
   ShareExtend.share("Successive Technologies, Noida, Uttar Pradesh  Web: https://successive.tech/  Phone number: +91-120-426-9272", "text",
...
padding: const EdgeInsets.all(32),
  child: Row(
   ...
   InkWell buildButtonColumn(Color color, IconData icon, String label,Function onTab) {
    return InkWell(
