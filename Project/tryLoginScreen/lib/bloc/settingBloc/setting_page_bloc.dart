...
SettingPageBloc() : super(SettingLoadingState()){
 ...
 bool isSwitchedNews;
  ...
  Stream<SettingPageState> mapEventToState(SettingPageEvent event) async*{
   ...
   yield SettingInitialState(isAdvertise: isSwitchedAvertise,isSwitchedNews:isSwitchedNews );
...
yield SettingSuccessState();
     ...
     //yield SettingSuccessState(isAdvertise: isSwitchedAvertise,isSwitchedNews:isSwitchedNews );
      //yield SettingInitialState(isAdvertise: isSwitchedAvertise,isSwitchedNews:isSwitchedNews );
